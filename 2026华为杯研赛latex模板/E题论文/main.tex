...
\section{问题背景与问题重述}
\subsection{问题背景分析}
情感是人机交互中的重要信息。真实视频里的态度与情绪通常由语言内容、声音的节奏和音高、面部表情及动作共同表达；单看转写文本，可能遗漏语气变化，单看声音或画面，也可能失去语义背景。多模态情感计算研究因此强调联合分析多种信号及其交互\cite{poria2016review,baltrusaitis2019multimodal}。本题以CMU-MOSEI英文多模态数据为基础，要求同时利用文本、语音和视觉信息预测情感极性与强度。
...
\midrule
Fixed baseline & 0.6126 & 0.5881 & 0.6164 & 0.6246 & 0.6506 & \keymetric{0.6041} & \keymetric{0.6576} & \keymetric{0.6532} \\
Final model & \keymetric{0.6374} & \keymetric{0.6016} & \keymetric{0.6123} & \keymetric{0.6296} & \keymetric{0.6644} & 0.5907 & 0.6588 & 0.6530 \\
\bottomrule
\end{tabular}
\end{table}
